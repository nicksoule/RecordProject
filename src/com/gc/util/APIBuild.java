...
public class APIBuild {
	...
	public static JSONObject ebayAPI(int pageNum, String month, String day1, String day2, String year) throws ClientProtocolException, IOException {
		...
		HttpGet getPage = new HttpGet("/services/search/FindingService/v1?OPERATION-NAME="
				...
				+ "value=50.00&itemFilter(2).name=EndTimeFrom&itemFilter(2).value=" + year + "-" + month + "-" + day1 + "T19:09:02.768Z&itemFilter(3)"
				+ ".name=EndTimeTo$itemFilter(3).value=" + year + "-" + month + "-" + day2 + "T19:09:02.768Z&paginationInput.pageNumber=" + pageNum);
